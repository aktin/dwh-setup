...
# install
apt-get -q -y install aptitude unzip wget curl git openjdk-8-jre-headless openjdk-8-jdk apt-offline libcurl3 php5-curl apache2 libaio1 libapache2-mod-php5 perl sed bc 
